...
* [ ] Change default passwords.☐Ensure that no custom subscription owner roles are created.
...
2. CSE Top 10 #3
3. Refer to [CCCS ITSP.30.031](https://cyber.gc.ca/en/guidance/user-authentication-guidance-information-technology-systems-itsp30031-v3)[V2 User Authentication Guidance for Information Technology Systems](https://cyber.gc.ca/en/guidance/user-authentication-guidance-information-technology-systems-itsp30031-v3)
